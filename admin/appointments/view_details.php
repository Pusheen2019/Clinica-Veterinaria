...
<div class="content py-3">
    <div class="card card-outline card-dark rounded-0">
        <div class="card-header rounded-0">
            <h5 class="card-title text-primary">Pedido de Marcação - Detallhes</h5>
        </div>
        <div class="card-body">
            <div class="container-fluid">
                <div id="outprint">
                    <fieldset>
                        ...
                        <div class="row">
                                <div class="col-md-6">
                                    <fieldset>
                                        <legend class="text-muted border-bottom">Informação Dono</legend>
                                        <table class="table table-stripped table-bordered" data-placeholder='true' id="">
                                            ...
                                            <tbody>
                                                <tr class="border-info">
                                                    <th class="py-1 px-2 text-light bg-gradient-info">Nome</th>
                                                ...
                                                <tr class="border-info">
                                                    ...
                                                    <th class="py-1 px-2 text-light bg-gradient-info">Morada</th>
                                ...
                                <div class="col-md-6">
                                    <fieldset>
                                        <legend class="text-muted border-bottom">Informação animal de estimação</legend>
                                        <table class="table table-stripped table-bordered" data-placeholder='true'>
                                            ...
                                            <tbody>
                                                <tr class="border-info">
                                                    <th class="py-1 px-2 text-light bg-gradient-info">Tipo de animal de estimação</th>
                                                    <td class="py-1 px-2 text-right"><?= ($pet_type) ?></td>
                                                </tr>
                                                <tr class="border-info">
                                                    <th class="py-1 px-2 text-light bg-gradient-info">Raça</th>
                                                    <td class="py-1 px-2 text-right"><?= ($breed) ?></td>
                                                </tr>
                                                <tr class="border-info">
                                                    <th class="py-1 px-2 text-light bg-gradient-info">Idade</th>
                                                    <td class="py-1 px-2 text-right"><?= ($age) ?></td>
                                                </tr>
                                                <tr class="border-info">
                                                    <th class="py-1 px-2 text-light bg-gradient-info">Serviço(s) necessários</th>
                            ...
                            <div class="row">
                                <div class="form-group col-md-4">
									...
									switch ($status){
										case 0:
											echo '<span class="ml-4 rounded-pill badge badge-primary">Pendentes</span>';
											break;
										case 1:
											echo '<span class="ml-4 rounded-pill badge badge-success">Confirmado</span>';
											break;
										case 2:
                ...
                <div class="rounded-0 text-center mt-3">
                        <a class="btn btn-sm btn-primary btn-flat" href="javascript:void(0)" id="update_status"><i class="fa fa-edit"></i> Editar Estado</a>
                        <button class="btn btn-sm btn-danger btn-flat" type="button" id="delete_data"><i class="fa fa-trash"></i> Apagar</button>
                        <a class="btn btn-light border btn-flat btn-sm" href="./?page=appointments" ><i class="fa fa-angle-left"></i> Voltar para a lista</a>
                </div>
            </div>
        </div>
    </div>
