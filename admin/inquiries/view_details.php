...
<div class="container-fluid">
    <div class="row">
        <div class="col-md-12">
            <dl>
                ...
                <dt class="text-primary">Telefone</dt>
                <dd class="pl-4"><?= isset($contact) ? $contact : "" ?></dd>
                <dt class="text-primary">Menssagem</dt>
    ...
    <div class="row">
        <div class="col-12 text-right">
            <button class="btn btn-flat btn-sm btn-dark" type="button" data-dismiss="modal"><i class="fa fa-times"></i> Fechar</button>
        </div>
    </div>
</div>