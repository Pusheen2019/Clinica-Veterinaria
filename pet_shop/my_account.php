        ...
        <div class="card rounded-0">
            <div class="card-body">
                <div class="w-100 justify-content-between d-flex">
                    <h4><b>Pedidos</b></h4>
                    <a href="./?p=edit_account" class="btn btn btn-dark btn-flat rounded-3"><div class="fa fa-user-cog"></div>Minha Conta</a>
                </div>
                            ...
                            ?>
                                <tr>
                                    ...
                                    <td class="text-center">
                                            <?php if($row['status'] == 0): ?>
                                                <span class="badge badge-light text-dark">Pendente</span>
                                            <?php elseif($row['status'] == 1): ?>
                                                <span class="badge badge-primary">Empacotada</span>
