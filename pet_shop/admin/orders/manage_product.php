...
<div class="card card-outline card-warning">
	<div class="card-header">
		<h3 class="card-title"><?php echo isset($id) ? "Update ": "Create New " ?> Produto</h3>
	</div>
	<div class="card-body">
		<form action="" id="product-form">
            ...
            <div class="form-group">
				<label for="sub_category_id" class="control-label">Sub Categoria</label>
                <select name="sub_category_id" id="sub_category_id" class="custom-select" required>
                <option value="" selected="" disabled="">Seleciona primeira a categoria</option>
                <?php
			...
			<div class="form-group">
				<label for="product_name" class="control-label">Nome Produto</label>
            ...
            <div class="form-group">
				<label for="" class="control-label">Imagens</label>
	...
	<div class="card-footer">
		<button class="btn btn-flat btn-success" form="product-form">Guardar</button>
		<a class="btn btn-flat btn-danger" href="?page=product">Cancelar</a>
	</div>
</div>
<script>
