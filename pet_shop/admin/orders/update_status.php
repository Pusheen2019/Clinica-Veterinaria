    ...
    <form id="status-update-form">
        ...
        <div class="form-group">
            ...
            <select name="status" id="" class="custom-select custol-select-sm">
                <option value="0" <?php echo $_GET['status'] == 0 ? "selected" : '' ?>>Pendente</option>
                <option value="1" <?php echo $_GET['status'] == 1 ? "selected" : '' ?>>Empacotado</option>
                <option value="2" <?php echo $_GET['status'] == 2 ? "selected" : '' ?>>Para entrega</option>
                <option value="3" <?php echo $_GET['status'] == 3 ? "selected" : '' ?>>Entregue</option>
