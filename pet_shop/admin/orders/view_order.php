...
<div class="card card-outline card-primary">
    <div class="card-body">
        <div class="conitaner-fluid">
            <p><b>Nome Cliente: <?php echo $client ?></b></p>
            <p><b>Morada de Entrega: <?php echo $delivery_address ?></b></p>
        ...
        <div class="row">
            <div class="col-6">
                <p>Metodo Pagamento: <?php echo $payment_method ?></p>
                <p>Estado Pagamento: <?php echo $paid == 0 ? '<span class="badge badge-dark">Não Pago</span>' : '<span class="badge badge-success">Pago</span>' ?></p>
            </div>
            <div class="col-6 row row-cols-2">
                <div class="col-3">Estado de Pedido:</div>
                <div class="col-9">
                <?php 
                    switch($status){
                        case '0':
                            echo '<span class="badge badge-light text-dark">Pendente</span>';
	                    break;
                        case '1':
                            echo '<span class="badge badge-primary">Empacotado</span>';
	                    break;
                        case '2':
                            echo '<span class="badge badge-warning">Para entrega</span>';
	                    break;
                        case '3':
                ...
                <div class="col-3"></div>
                <div class="col">
                    <button type="button" id="update_status" class="btn btn-sm btn-flat btn-primary">Atualizar Estado</button>
                </div>
                <?php endif; ?>
