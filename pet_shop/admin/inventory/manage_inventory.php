...
<div class="card card-outline card-warning">
	<div class="card-header">
		<h3 class="card-title"><?php echo isset($id) ? "Update ": "Criar " ?> Inventario</h3>
	</div>
	<div class="card-body">
		<form action="" id="inventory-form">
            ...
            <div class="form-group">
				<label for="quantity" class="control-label">Quantidade inicial</label>
	...
	<div class="card-footer">
		<button class="btn btn-flat btn-success" form="inventory-form">Guardar</button>
		<a class="btn btn-flat btn-danger" href="?page=inventory">Cancelar</a>
	</div>
</div>
<script>
