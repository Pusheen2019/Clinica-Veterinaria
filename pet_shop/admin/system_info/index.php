...
<div class="col-lg-12">
	<div class="card card-outline card-primary">
		<div class="card-header">
			<h5 class="card-title">Informações Sistema</h5>
		...
		<div class="card-body">
			...
			<div class="form-group">
				<label for="" class="control-label">Capa Website</label>
				<div class="custom-file">
	              <input type="file" class="custom-file-input rounded-circle" id="customFile" name="cover" onchange="displayImg2(this,$(this))">
	              <label class="custom-file-label" for="customFile">Escolhre Ficheiro</label>
	            </div>
			</div>
			<div class="form-group d-flex justify-content-center">
