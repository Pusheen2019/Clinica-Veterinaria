            ...
            <div class="container px-4 px-lg-5 ">
                ...
                <form class="form-inline" id="search-form">
                  <div class="input-group">
                    <input class="form-control form-control-sm form " type="search" placeholder="Procurar" aria-label="Search" name="search"  value="<?php echo isset($_GET['search']) ? $_GET['search'] : "" ?>"  aria-describedby="button-addon2">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav me-auto mb-2 mb-lg-0 ms-lg-4">
                        ...
                        <?php endif; ?>
                        <?php endwhile; ?>
                        <li class="nav-item"><a class="nav-link" href="../">Marcações</a></li>
                        <li class="nav-item"><a class="nav-link" href="./?p=about">Sobre</a></li>
                        <li class="nav-item"><a class="nav-link" href="./?p=promocao">Promoções</a></li>
                    ...
                    <div class="d-flex align-items-center">
                      <?php if(!isset($_SESSION['userdata']['id'])): ?>
                        ...
                        <a class="text-dark mr-2 nav-link" href="./?p=cart">
                            ...
                            <a href="./?p=my_account" class="text-dark  nav-link"><b> Olá, <?php echo $_settings->userdata('firstname')?>!</b></a>
