        ...
        <div class="card rounded-0">
            <div class="card-body">
                <div class="w-100 justify-content-between d-flex">
                    <h4><b>Atualizar conta</b></h4>
                    <a href="./?p=my_account" class="btn btn btn-dark btn-flat"><div class="fa fa-angle-left"></div> Voltar para a lista</a>
                </div>
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="hidden" name="id" value="<?php echo $_settings->userdata('id') ?>">
                            ...
                            <div class="form-group">
                                <label for="lastname" class="control-label">Ultimo Nome</label>
                            ...
                            <div class="form-group">
                                ...
                                <select name="gender" id="" class="custom-select select" required>
                                    ...
                                    <option <?php echo $_settings->userdata('gender') == "Feminino" ? "selected" : '' ?>>Feminino</option>
                                </select>
                            </div>
                            <div class="form-group">
