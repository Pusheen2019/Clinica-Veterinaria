        ...
        <div class="col-md-5">
            <div class="card card-outline card-navy rounded-0 shadow">
                <div class="card-header">
                    <h4 class="card-title">Informação de Contacto</h4>
                </div>
                <div class="card-body rounded-0">
                    <dl>
                        <dt class="text-muted"><i class="fa fa-envelope"></i> Email</dt>
                        <dd class="pl-4"><?= $_settings->info('email') ?></dd>
                        <dt class="text-muted"><i class="fa fa-phone"></i> Telefone</dt>
                        ...
                        <dt class="text-muted"><i class="fa fa-paw"></i> Marcação Maxima de</dt>
                    ...
                    <form action="" id="message-form">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <small class="px-3 text-muted">Nome Completo</small>
                            </div>
                            <div class="col-md-6">
                                ...
                                <small class="px-3 text-muted">Telefone</small>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-6">
                        ...
                        <div class="row">
                            <div class="form-group col-md-12">
                                <small class="text-muted">Menssagem</small>
                        ...
                        <div class="row">
                            <div class="form-group col-md-12 text-center">
                                <button class="btn btn-primary rounded-pill col-5">Enviar</button>
                            </div>
                        </div>
                    </form>
                </div>
