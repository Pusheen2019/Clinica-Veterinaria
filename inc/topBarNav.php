...
<!-- Navbar -->
      ...
      <nav class="w-100 px-2 py-1 position-fixed top-0 bg-light text-bold" id="login-nav">
        <div class="d-flex justify-content-between w-100">
          ...
          <div>
            <?php if($_settings->userdata('id') > 0): ?>
              ...
              <span class="mx-2">Olá, <?= !empty($_settings->userdata('username')) ? $_settings->userdata('username') : $_settings->userdata('email') ?></span>
      ...
      <nav class="main-header navbar navbar-expand navbar-light border-0 text-bold bg-gradient-warning" id='top-Nav'>
        ...
        <div class="container">
          ...
          <div class="collapse navbar-collapse order-3 text-dark" id="navbarCollapse">
            <!-- Left navbar links -->
            <ul class="navbar-nav">
              <li class="nav-item">
              ...
              <li class="nav-item">
                <a href="./?page=appointment" class="nav-link <?= isset($page) && $page =='appointment' ? "active" : "" ?>">Marcações</a>
              </li>
              <li class="nav-item">
                <a href="./?page=services" class="nav-link <?= isset($page) && $page =='services' ? "active" : "" ?>">Serviços</a>
              </li>
              <li class="nav-item">
                <a href="./?page=about" class="nav-link <?= isset($page) && $page =='about' ? "active" : "" ?>">Sobre nós</a>
              </li>
              <li class="nav-item">
                <a href="./pet_shop" class="nav-link <?= isset($page) && $page =='pet_shop' ? "active" : "" ?>">PetSHop</a>
              </li>
              <li class="nav-item">
