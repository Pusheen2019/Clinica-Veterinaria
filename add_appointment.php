...
<div class="container-fluid">
    <form action="" id="appointment-form">
        ...
        <div class="row">
            <div class="col-md-6">
                <fieldset>
                    <legend class="text-muted">Informação do Dono</legend>
                    <div class="form-group">
                        <label for="owner_name" class="control-label">Nome</label>
            ...
            <div class="col-md-6">
                <fieldset>
                    <legend class="text-muted">Informação do animal de estimação</legend>
                    <div class="form-group">
                        <label for="category_id" class="control-label">Tipo de animal</label>
                ...
                <div class="form-group">
                    <label for="service_id" class="control-label">Serviço(s))</label>
                    <?php 
